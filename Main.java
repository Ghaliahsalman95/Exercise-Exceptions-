...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Lab1 with TRY CATCH THROW EXCEPTIONS");
        try {
//------------------------------------------------Exercise 1---------------------------------
...
//------------------------------------------------Exercise 3---------------------------------
            ...
            if(radius<=0){// check if radius legall or not if not throw ArithmeticException
                throw new ArithmeticException("Radius<=0 NOT ACCEPTABLE");
            }
            System.out.println("Output: ");
...
//------------------------------------------------Exercise 4---------------------------------
            ...
            if(set<=0){throw new ArithmeticException("SET<=0 NOT ACCEPTABLE");}
            else{
                for (int s = 1; s <= set; s++) {
...
//------------------------------------------------Exercise 5---------------------------------
            ...
            equals = ar[0] + ar[1];
            if (equals == ar[2]) {
                System.out.println("Two addition are Equals with third number");
            } else {
                System.out.println("Two addition are Not Equals with third number");
            }
...
//------------------------------------------------Exercise 6---------------------------------
            ...
            String word = reverseM(input.next());
            System.out.println("Word is " + word);
            word = word.replace(" ", "");

            System.out.println("Reverse word is." + word);
...
//--------------------------------------------Exercise 9---------------------------------
            ...
            { throw new IndexOutOfBoundsException("Index Out Of Bounds Of String");
                //    System.out.println("Output is: "+strchsr.charAt(index));
            }
            else{ System.out.println("Output is: "+strchsr.charAt(index));}
...
//--------------------------------------------Exercise 10---------------------------------
            ...
            if(width<=0 ||height<=0){
                throw new ArithmeticException("Width or Height MUST BE ONLY Greater than 0 ");
            }
...
//--------------------------------------------Exercise 12---------------------------------
            ...
            if(seconds<=0){throw new Exception("THERE IS NO SECONDS <= ZERO");}
...
////----------------------------------------------Exercise 16----------------------------
            ...
            System.out.println("The Number is " + reverseM(Integer.toString(resNumber)));
...
////----------------------------------------------Exercise 18----------------------------
        ...
        }//-----------------------------------END OF TRY MAIN METHOD-------------------------
        //------------------------------------HERE Catch Cover All Expected EXCEPTION----------------
        catch (InputMismatchException e) {
            System.out.println("INPUT MUST BE INTEGER");
        }

        catch (IndexOutOfBoundsException e){
            // System.out.println("IndexOutOfBoundsException");to check if it comes compiler here
            ...
            System.out.println("IN CASE MISSING HANDLING SOME EXCEPTION "+e.getMessage());

        }
        finally {
            System.out.println("Every Things is DONE ");
        }
        ///--there is  3 throw in some of if statement
    }

    public static String reverseM(String reverse){
        String str="";
        reverse = reverse.replace(" ", "");
        for (int pal = reverse.length() - 1; pal >= 0; pal--) {
            str+=reverse.charAt(pal);}
